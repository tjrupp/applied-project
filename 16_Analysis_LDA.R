...
top_reviews1 <- reviews %>% 
  select(content, app, Topic_1) %>%
  #group_by(app) %>% 
  arrange(Topic_1) %>%
  top_n(10) 

top_reviews2 <- reviews %>% 
  select(content, app, Topic_2) %>%
  #group_by(app) %>% 
  arrange(Topic_2) %>%
  top_n(10) 

top_reviews3 <- reviews %>% 
  select(content, app, Topic_3) %>%
  #group_by(app) %>% 
  arrange(Topic_3) %>%
  top_n(10) 

top_reviews4 <- reviews %>% 
  select(content, app, Topic_4) %>%
  #group_by(app) %>% 
  arrange(Topic_4) %>%
  top_n(500) 

top_reviews5 <- reviews %>% 
  select(content, app, Topic_5) %>%
  #group_by(app) %>% 
  arrange(Topic_5) %>%
  top_n(10) 

top_reviews6 <- reviews %>% 
  select(content, app, Topic_6) %>%
  #group_by(app) %>% 
  arrange(Topic_6) %>%
  top_n(10) 
...
patchnotes %>%
  select(app, Topic_1, Topic_2, Topic_3, Topic_4) %>%
  group_by(app) %>%
