...
#read patch notes from database
patchnotes = pd.read_sql('SELECT content FROM patchnotes;', conn)

#convert to list
patchnotes = patchnotes.values.tolist()

#convert each element to string
patchnotes = [str(i) for i in patchnotes]

#save as all texts
all_texts = patchnotes
...
pyLDAvis.save_html(vis, 'lda_patchnotes1.html')
...
#save values in sql
all_topics_df.to_sql("LDA_patchnotes", conn)
